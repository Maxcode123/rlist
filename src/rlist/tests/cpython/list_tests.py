...
from .support import ALWAYS_EQ, NEVER_EQ, get_c_recursion_limit
...
class CommonTest(seq_tests.CommonTest):
    ...
    def test_repr(self):
        ...
        self.assertEqual(str(a2), "<rlist: [0, 1, 2]>")
        self.assertEqual(repr(a2), "<rlist: [0, 1, 2]>")

        a2.append(a2)
        a2.append(3)
        self.assertEqual(str(a2), "<rlist: [0, 1, 2, <rlist: [...]>, 3]>")
        self.assertEqual(repr(a2), "<rlist: [0, 1, 2, <rlist: [...]>, 3]>")
